...
.method public handleMessage(Landroid/os/Message;)V
    ...
    check-cast v26, Lcom/android/server/BackupManagerService$BackupRequest;

    .local v26, "b":Lcom/android/server/BackupManagerService$BackupRequest;
    ...
    .end local v26    # "b":Lcom/android/server/BackupManagerService$BackupRequest;
    ...
    check-cast v29, Lcom/android/server/BackupManagerService$FullBackupParams;

    .local v29, "params":Lcom/android/server/BackupManagerService$FullBackupParams;
    ...
    iget-object v0, v0, Lcom/android/server/BackupManagerService$FullBackupParams;->domainTokens:[Ljava/lang/String;

    move-object/from16 v21, v0

    move-object/from16 v0, v29

    iget-object v0, v0, Lcom/android/server/BackupManagerService$FullBackupParams;->excludeFilesRegex:Ljava/lang/String;

    move-object/from16 v22, v0

    move-object/from16 v0, v29

    iget-boolean v0, v0, Lcom/android/server/BackupManagerService$FullBackupParams;->shouldKillAfterBackup:Z

    move/from16 v23, v0

    move-object/from16 v0, v29

    iget-boolean v0, v0, Lcom/android/server/BackupManagerService$FullBackupParams;->noninteractive:Z

    move/from16 v24, v0

    move-object/from16 v0, v29

    iget-boolean v0, v0, Lcom/android/server/BackupManagerService$FullBackupParams;->ignoreEncryptionPasswordCheck:Z

    move/from16 v25, v0

    invoke-direct/range {v8 .. v25}, Lcom/android/server/BackupManagerService$PerformFullBackupTask;-><init>(Lcom/android/server/BackupManagerService;Landroid/os/ParcelFileDescriptor;Landroid/app/backup/IFullBackupRestoreObserver;ZZZLjava/lang/String;Ljava/lang/String;ZZ[Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicBoolean;[Ljava/lang/String;Ljava/lang/String;ZZZ)V
    ...
    .end local v29    # "params":Lcom/android/server/BackupManagerService$FullBackupParams;
    :pswitch_5
    move-object/from16 v0, p1
    ...
    check-cast v29, Lcom/android/server/BackupManagerService$RestoreParams;

    .local v29, "params":Lcom/android/server/BackupManagerService$RestoreParams;
    const-string v3, "BackupManagerService"
    ...
    .end local v29    # "params":Lcom/android/server/BackupManagerService$RestoreParams;
    ...
    check-cast v29, Lcom/android/server/BackupManagerService$FullRestoreParams;

    .local v29, "params":Lcom/android/server/BackupManagerService$FullRestoreParams;
    ...
    iget-boolean v13, v0, Lcom/android/server/BackupManagerService$FullRestoreParams;->ignoreEncryptionPasswordCheck:Z

    move-object/from16 v0, v29

    iget-object v14, v0, Lcom/android/server/BackupManagerService$FullRestoreParams;->observer:Landroid/app/backup/IFullBackupRestoreObserver;

    move-object/from16 v0, v29

    iget-object v15, v0, Lcom/android/server/BackupManagerService$FullRestoreParams;->latch:Ljava/util/concurrent/atomic/AtomicBoolean;

    move-object/from16 v0, v29

    iget-boolean v0, v0, Lcom/android/server/BackupManagerService$FullRestoreParams;->noninteractive:Z

    move/from16 v16, v0

    move-object/from16 v0, v29

    iget-boolean v0, v0, Lcom/android/server/BackupManagerService$FullRestoreParams;->ignoreVersionMismatchCheck:Z

    move/from16 v17, v0

    invoke-direct/range {v8 .. v17}, Lcom/android/server/BackupManagerService$PerformFullRestoreTask;-><init>(Lcom/android/server/BackupManagerService;Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Ljava/lang/String;ZLandroid/app/backup/IFullBackupRestoreObserver;Ljava/util/concurrent/atomic/AtomicBoolean;ZZ)V
    ...
    .end local v29    # "params":Lcom/android/server/BackupManagerService$FullRestoreParams;
    :pswitch_7
    move-object/from16 v0, p1
    ...
    check-cast v29, Lcom/android/server/BackupManagerService$ClearParams;

    .local v29, "params":Lcom/android/server/BackupManagerService$ClearParams;
    ...
    .end local v29    # "params":Lcom/android/server/BackupManagerService$ClearParams;
    :pswitch_8
    move-object/from16 v0, p1
    ...
    check-cast v29, Lcom/android/server/BackupManagerService$ClearRetryParams;

    .local v29, "params":Lcom/android/server/BackupManagerService$ClearRetryParams;
    move-object/from16 v0, p0
    ...
    .end local v29    # "params":Lcom/android/server/BackupManagerService$ClearRetryParams;
    :pswitch_9
    move-object/from16 v0, p0
    ...
    check-cast v29, Lcom/android/server/BackupManagerService$RestoreGetSetsParams;

    .local v29, "params":Lcom/android/server/BackupManagerService$RestoreGetSetsParams;
    :try_start_c
    move-object/from16 v0, v29
    ...
    .end local v27    # "e":Ljava/lang/Exception;
    .end local v29    # "params":Lcom/android/server/BackupManagerService$RestoreGetSetsParams;
    ...
    check-cast v29, Lcom/android/server/BackupManagerService$FullParams;

    .local v29, "params":Lcom/android/server/BackupManagerService$FullParams;
    if-eqz v29, :cond_c
    ...
    .end local v29    # "params":Lcom/android/server/BackupManagerService$FullParams;
    :catchall_7
    move-exception v3
    ...
    .restart local v29    # "params":Lcom/android/server/BackupManagerService$FullParams;
    :cond_c
    :try_start_1a
    const-string v3, "BackupManagerService"
