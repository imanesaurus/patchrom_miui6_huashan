...
local-out-zip-file := MIUI_huashan.zip
...
local-miui-modified-apps := MiuiFramework MiuiHome Settings SecurityCenter MiuiSystemUI DeskClock
...
PORT_PRODUCT：= huashan_imanesaurus
